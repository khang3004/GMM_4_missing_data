...
\input{sections/gmm/01_hook.tex}
\input{sections/gmm/02_formulation.tex}
\input{sections/gmm/03_algorithm.tex}
\input{sections/gmm/04_implementation.tex}
\input{sections/gmm/05_results.tex}
\input{sections/gmm/06_takeaways.tex}
